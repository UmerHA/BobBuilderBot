...
from builderbot.parsers.code_change import CodeChange, CodeFileChange, Insertion, Deletion, Replacement
...
def test_insertion():
    ...
    assert new_base.files[0].lines[2].content == "new line 3"
...
def test_replacement():
    ...
    assert new_base.files[0].lines[2].content == "updated line 3"
